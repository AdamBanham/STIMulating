"""
Django settings for STIMulating project.
...
SECRET_KEY = '^1q*j)@%2r)9hd=rx##3enoxq^stxod+eu_8ye+-8jrh9b^xn='
...
WSGI_APPLICATION = 'STIMulating.wsgi.application'
