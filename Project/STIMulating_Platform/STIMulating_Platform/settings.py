"""
Django settings for STIMulating_Platform project.
...
SECRET_KEY = '@nn)bzv9#*4q19&r0v1d4mtvryeh!6i388acw031v=(%)*kkkp'
...
ROOT_URLCONF = 'STIMulating_Platform.urls'
...
WSGI_APPLICATION = 'STIMulating_Platform.wsgi.application'
